...
CREATE TABLE `endereco` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COMMENT='Tabela que reune endereços de clientes, usuários ou imóveis.';
...
INSERT INTO `endereco` VALUES (1,'Avenida Alfredo Lisboa','Recife Antigo','Recife','PE','180','ArmazÃ©m 12','54450020','Ao lado da praÃ§a do Marco Zero','-8.063583','-34.871192');
...
CREATE TABLE `usuario` (
  ...
  KEY `fk_usuario_endereco_idx` (`endereco`),
  CONSTRAINT `fk_usuario_endereco` FOREIGN KEY (`endereco`) REFERENCES `endereco` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2018-02-11 18:38:48
